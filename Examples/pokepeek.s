# Indirect-addressing RAM load and store functionality
# Note that address 0xFF will be munged by the TBF instruction
# and can't really be used.
# peek and poke together use up 119 instructions
# --
# Chris Baird,, <cjb@brushtail.apana.org.au> 2017-Nov-03
...
ret1:
        ...
        DMAB peekhi
        SMIA peekhi
        LCB 2                   # 1 if you want to see 0xF0-FF
        ADDM
end:
        JMP loop | C JMP end
...
peekcx:
        ...
        | LMA 0xCC | LMA 0xCD | LMA 0xCE | LMA 0xDF
        JMP peekfinish
...
peekfinish:
        LMB peekcaller
        TBF
panic1:  JMP panic1 | nzvc JMP ret1

###
# poke - ram location to access in pokehi,pokelo
# returns value in A
...
pokefinish:
        LMB pokecaller
        TBF                     # this munges 0xFF
panic2:
        JMP panic2 | nzvc JMP ret0
