...
m1loop:
	...
	LMB m1
	TBF
	JMP end | nzvc SMA b1 | nzvC SMA b2 | nzVc SMA b3 | nzVC SMA b4 | nZvc SMA b5 | nZvC SMA b6 | nZVc SMA b7 | nZVC SMA b8 | Nzvc SMA b9

m2loop:
	LMB m2		# Get the possible m2 position
	TBF
			# Skip if already occupied
	JMP m1clr | nzvc LMB b1 | nzvC LMB b2 | nzVc LMB b3 | nzVC LMB b4 | nZvc LMB b5 | nZvC LMB b6 | nZVc LMB b7 | nZVC LMB b8 | Nzvc LMB b9
	TBF
	LCA O | nzvC JMP m2inc | Nzvc JMP m2inc
	LMB m2
	TBF		# Store an O on the board at position m1
	JMP m1clr | nzvc SMA b1 | nzvC SMA b2 | nzVc SMA b3 | nzVC SMA b4 | nZvc SMA b5 | nZvC SMA b6 | nZVc SMA b7 | nZVC SMA b8 | Nzvc SMA b9

m3loop:
	LMB m3		# Get the possible m3 position
	TBF
			# Skip if already occupied
	JMP m2clr | nzvc LMB b1 | nzvC LMB b2 | nzVc LMB b3 | nzVC LMB b4 | nZvc LMB b5 | nZvC LMB b6 | nZVc LMB b7 | nZVC LMB b8 | Nzvc LMB b9
	TBF
	LCA X | nzvC JMP m3inc | Nzvc JMP m3inc
	LMB m3
	TBF		# Store an X on the board at position m3
	JMP m2clr | nzvc SMA b1 | nzvC SMA b2 | nzVc SMA b3 | nzVC SMA b4 | nZvc SMA b5 | nZvC SMA b6 | nZVc SMA b7 | nZVC SMA b8 | Nzvc SMA b9

m4loop:
	LMB m4		# Get the possible m4 position
	TBF
			# Skip if already occupied
	JMP m3clr | nzvc LMB b1 | nzvC LMB b2 | nzVc LMB b3 | nzVC LMB b4 | nZvc LMB b5 | nZvC LMB b6 | nZVc LMB b7 | nZVC LMB b8 | Nzvc LMB b9
	TBF
	LCA O | nzvC JMP m4inc | Nzvc JMP m4inc
	LMB m4
	TBF		# Store an O on the board at position m4
	JMP m3clr | nzvc SMA b1 | nzvC SMA b2 | nzVc SMA b3 | nzVC SMA b4 | nZvc SMA b5 | nZvC SMA b6 | nZVc SMA b7 | nZVC SMA b8 | Nzvc SMA b9

m5loop:
	LMB m5		# Get the possible m5 position
	TBF
			# Skip if already occupied
	JMP m4clr | nzvc LMB b1 | nzvC LMB b2 | nzVc LMB b3 | nzVC LMB b4 | nZvc LMB b5 | nZvC LMB b6 | nZVc LMB b7 | nZVC LMB b8 | Nzvc LMB b9
	TBF
	LCA X | nzvC JMP m5inc | Nzvc JMP m5inc
	LMB m5
	TBF		# Store an X on the board at position m5
	JMP m4clr | nzvc SMA b1 | nzvC SMA b2 | nzVc SMA b3 | nzVC SMA b4 | nZvc SMA b5 | nZvC SMA b6 | nZVc SMA b7 | nZVC SMA b8 | Nzvc SMA b9
	LCA 0
...
m6loop:
	...
	TBF
			# Skip if already occupied
	JMP m5clr | nzvc LMB b1 | nzvC LMB b2 | nzVc LMB b3 | nzVC LMB b4 | nZvc LMB b5 | nZvC LMB b6 | nZVc LMB b7 | nZVC LMB b8 | Nzvc LMB b9
	TBF
	LCA O | nzvC JMP m6inc | Nzvc JMP m6inc
	LMB m6
	TBF		# Store an O on the board at position m6
	JMP m5clr | nzvc SMA b1 | nzvC SMA b2 | nzVc SMA b3 | nzVC SMA b4 | nZvc SMA b5 | nZvC SMA b6 | nZVc SMA b7 | nZVC SMA b8 | Nzvc SMA b9
	LCA 1
	JMP winboard	# See if there is a winner
m6nowin:
...
m7loop:
	...
	TBF
			# Skip if already occupied
	JMP m6clr | nzvc LMB b1 | nzvC LMB b2 | nzVc LMB b3 | nzVC LMB b4 | nZvc LMB b5 | nZvC LMB b6 | nZVc LMB b7 | nZVC LMB b8 | Nzvc LMB b9
	TBF
	LCA X | nzvC JMP m7inc | Nzvc JMP m7inc
	LMB m7
	TBF		# Store an X on the board at position m7
	JMP m6clr | nzvc SMA b1 | nzvC SMA b2 | nzVc SMA b3 | nzVC SMA b4 | nZvc SMA b5 | nZvC SMA b6 | nZVc SMA b7 | nZVC SMA b8 | Nzvc SMA b9
	LCA 2
	JMP winboard	# See if there is a winner
m7nowin:
...
m8loop:
	...
	TBF
			# Skip if already occupied
	JMP m7clr | nzvc LMB b1 | nzvC LMB b2 | nzVc LMB b3 | nzVC LMB b4 | nZvc LMB b5 | nZvC LMB b6 | nZVc LMB b7 | nZVC LMB b8 | Nzvc LMB b9
	TBF
	LCA O | nzvC JMP m8inc | Nzvc JMP m8inc
	LMB m8
	TBF		# Store an O on the board at position m8
	JMP m7clr | nzvc SMA b1 | nzvC SMA b2 | nzVc SMA b3 | nzVC SMA b4 | nZvc SMA b5 | nZvC SMA b6 | nZVc SMA b7 | nZVC SMA b8 | Nzvc SMA b9
	LCA 3
	JMP winboard	# See if there is a winner
m8nowin:
...
m9loop:
	...
	TBF
			# Skip if already occupied
	JMP m8clr | nzvc LMB b1 | nzvC LMB b2 | nzVc LMB b3 | nzVC LMB b4 | nZvc LMB b5 | nZvC LMB b6 | nZVc LMB b7 | nZVC LMB b8 | Nzvc LMB b9
	TBF
	LCA X | nzvC JMP m9inc | Nzvc JMP m9inc
	LMB m9
	TBF		# Store an X on the board at position m9
	JMP m8clr | nzvc SMA b1 | nzvC SMA b2 | nzVc SMA b3 | nzVC SMA b4 | nZvc SMA b5 | nZvC SMA b6 | nZVc SMA b7 | nZVC SMA b8 | Nzvc SMA b9
	LCA 4
	JMP winboard
m9nowin:
m9win:
...
end:    JMP end | nzvc JMP m5win | nzvC JMP m6win | nzVc JMP m7win | nzVC JMP m8win | nZvc JMP m9win
nowinret:
	LMB caller	# Load caller id
        TBF             # Transfer caller to flags
                        # Jump based on flags value
end:    JMP end | nzvc JMP m5nowin | nzvC JMP m6nowin | nzVc JMP m7nowin | nzVC JMP m8nowin | nZvc JMP m9nowin
